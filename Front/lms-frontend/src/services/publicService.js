...
export const publicService = {
  ...
  getHotEbooks: async () => {
    const response = await api.get('/ebooks/hot');
    return response.data;
  },

  getFeaturedEbooks: async () => {
    const response = await api.get('/ebooks/featured');
    return response.data;
  },

  getCarouselEbooks: async () => {
    const response = await api.get('/ebooks/carousel');
    return response.data;
  },
