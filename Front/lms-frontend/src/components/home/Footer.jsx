        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              <a href="#" className="text-slate-400 hover:text-white transition-colors bg-slate-800 p-2 rounded-full hover:bg-indigo-600"><Share2 size={18} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <button className="bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg py-2.5 px-4 flex items-center justify-center gap-3 transition-colors">
